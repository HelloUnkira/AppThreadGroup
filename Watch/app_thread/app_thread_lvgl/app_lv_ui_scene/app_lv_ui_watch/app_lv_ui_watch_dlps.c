 ...
 *@param[in] scene 场景
 */
static void app_lv_ui_watch_dlps_show(void *scene)
{
    ...
    app_lv_scene_watch_dlps.self = app_lv_ui_res_local == NULL ? NULL :
 ...
 *@param[in] scene 场景
 */
static void app_lv_ui_watch_dlps_hide(void *scene)
{
    if (app_lv_ui_res_local != NULL) {
        /* 反初始化场景 */
...
app_lv_scene_t app_lv_scene_watch_dlps = {
    /* 场景资源节点 */
    .show = app_lv_ui_watch_dlps_show,
    .hide = app_lv_ui_watch_dlps_hide,
};
