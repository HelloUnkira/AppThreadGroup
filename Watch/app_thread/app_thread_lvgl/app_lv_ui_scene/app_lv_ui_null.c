...
static void app_lv_ui_null_show(void *scene)
{
    if (app_lv_ui_res_local == NULL) {
        ...
        lv_obj_set_style_bg_color(app_lv_ui_res_local->scene, lv_palette_main(LV_PALETTE_GREY), 0);
        lv_obj_set_style_border_side(app_lv_ui_res_local->scene, 0, 0);
        lv_obj_set_style_border_width(app_lv_ui_res_local->scene, 0, 0);
        lv_obj_set_style_border_color(app_lv_ui_res_local->scene, lv_palette_main(LV_PALETTE_GREY), 0);
        /* 初始化居中标签 */
