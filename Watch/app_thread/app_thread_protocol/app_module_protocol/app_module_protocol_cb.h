...
extern void app_module_protocol_tx_empty(app_module_protocol_package_t *package);
extern void app_module_protocol_rx_empty(app_module_protocol_package_t *package);
