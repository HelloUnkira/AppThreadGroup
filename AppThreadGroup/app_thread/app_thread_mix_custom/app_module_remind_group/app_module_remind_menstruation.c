...
void app_module_remind_menstruation_dump(void)
{
    ...
    // memcpy(&data_center->remind_menstruation.menstruation_item, app_module_remind_menstruation_item, sizeof(app_module_remind_menstruation_item));
    // memcpy(&data_center->remind_menstruation.menstruation_info, app_module_remind_menstruation_info, sizeof(app_module_remind_menstruation_info));
...
void app_module_remind_menstruation_load(void)
{
    ...
    app_module_data_center_t *data_center = app_module_data_center_take(app_module_data_center_module_source);
    app_module_remind_menstruation_array_lock();
    // memcpy(app_module_remind_menstruation_item, &data_center->remind_menstruation.menstruation_item, sizeof(app_module_remind_menstruation_item));
    // memcpy(app_module_remind_menstruation_info, &data_center->remind_menstruation.menstruation_info, sizeof(app_module_remind_menstruation_info));
    app_module_remind_menstruation_array_unlock();
    app_module_data_center_give();
}
