...
/*@brief lvgl ui数据交互回调
 */
static void app_lv_ui_measure(void)
{
...
/*@brief lvgl ui数据交互回调
 */
static bool app_lv_ui_measure_status(void)
{
...
/*@brief lvgl ui数据交互回调
 */
static bool app_lv_ui_measure_result(void)
{
...
/*@brief lvgl ui数据交互回调
 */
static float app_lv_ui_get_value(void)
{
    return app_module_temperature_measure_value();
}

app_lv_ui_temperature_presenter_t app_lv_ui_temperature_presenter = {
    .measure        = app_lv_ui_measure,
    .measure_status = app_lv_ui_measure_status,
    .measure_result = app_lv_ui_measure_result,
    .get_value      = app_lv_ui_get_value,
};
