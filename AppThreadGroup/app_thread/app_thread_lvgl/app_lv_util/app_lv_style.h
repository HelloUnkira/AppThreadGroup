 ...
 *@retval    转换后的像素
 */
static inline lv_coord_t app_lv_style_zoom_x(lv_coord_t x)
{
 ...
 *@retval    转换后的像素
 */
static inline lv_coord_t app_lv_style_zoom_y(lv_coord_t y)
{
 ...
 *@retval    转换后的像素
 */
static inline lv_coord_t app_lv_style_hor_pct(uint8_t pct)
{
 ...
 *@retval    转换后的像素
 */
static inline lv_coord_t app_lv_style_ver_pct(uint8_t pct)
{
