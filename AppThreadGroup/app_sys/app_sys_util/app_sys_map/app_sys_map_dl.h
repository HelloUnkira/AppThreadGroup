 ...
 *@param m 图实例
 *@param v 起始图顶点实例
 *@param args(.v_cnt, .v_path, .record, .e_w_ary, .e_w_max, .e_w_cb)
 */
 ...
 *@param m 图实例
 *@param v 起始图顶点实例
 *@param args(.v_cnt, .record, .e_w_max, .e_w_mat_t, .e_w_mat, .e_w_cb)
 */
 ...
 *@param m 图实例
 *@param v 起始图顶点实例
 *@param args(.v_cnt, .record, .e_w_max, .e_w_mat_t, .e_w_mat, .set, .set_parent, .e_w_cb)
 */
