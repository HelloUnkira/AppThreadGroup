...
static HDC app_dev_gui_disp_frame_buffer(HWND WindowHandle, LONG Width, LONG Height, UINT32** PixelBuffer, SIZE_T* PixelBufferSize)
{
    ...
    if (PixelBuffer && PixelBufferSize) {
        ...
        #if 0
        #elif APP_DEV_GUI_IS_LVGL
        #define APP_DEV_GUI_COLOR_DEPTH     LV_COLOR_DEPTH
        #elif APP_DEV_GUI_IS_SCUI
        #define APP_DEV_GUI_COLOR_DEPTH     SCUI_PCF_DEP
        #else
        #endif
        ...
        {
            #if 0
            #elif APP_DEV_GUI_COLOR_DEPTH == 32
            BITMAPINFO bitmap_info = { 0 };
            #elif APP_DEV_GUI_COLOR_DEPTH == 16
            typedef struct {
            ...
            #elif APP_DEV_GUI_COLOR_DEPTH == 8
            typedef struct {
                BITMAPINFOHEADER bmiHeader;
            ...
            #elif APP_DEV_GUI_COLOR_DEPTH == 1
            typedef struct {
                BITMAPINFOHEADER bmiHeader;
                RGBQUAD bmiColors[2];
