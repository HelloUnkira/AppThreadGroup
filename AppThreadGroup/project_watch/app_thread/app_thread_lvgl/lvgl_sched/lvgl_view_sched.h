...
typedef struct {
    ...
    lvgl_view_id_t page_l;        // 左临近窗口
    lvgl_view_id_t page_r;        // 右临近窗口
    lvgl_view_id_t page_t;        // 上临近窗口
    lvgl_view_id_t page_b;        // 下临近窗口
    lvgl_view_tr_t transform_l;   // 左临近窗口特效交互
    lvgl_view_tr_t transform_r;   // 右临近窗口特效交互
    lvgl_view_tr_t transform_t;   // 上临近窗口特效交互
    lvgl_view_tr_t transform_b;   // 下临近窗口特效交互
    lv_coord_t enc_l:1; // 编码器旋转唤出左窗口
    lv_coord_t enc_r:1; // 编码器旋转唤出右窗口
    lv_coord_t enc_t:1; // 编码器旋转唤出上窗口
    lv_coord_t enc_b:1; // 编码器旋转唤出下窗口
