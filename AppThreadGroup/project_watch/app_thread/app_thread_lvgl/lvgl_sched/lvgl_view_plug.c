...
void lvgl_plug_watch_global_enc_async_call(void *user_data)
{
    ...
    if ((enc_dir & (LV_DIR_TOP | LV_DIR_LEFT)) != 0)
    {
        ...
        if ((enc_dir & LV_DIR_TOP) != 0)
            if (lvgl_view_obj_tree_scrollable(page_c, LV_DIR_TOP, &obj_scrollable,
                                              &obj_dist))
            {
        ...
        if ((enc_dir & LV_DIR_LEFT) != 0)
            if (lvgl_view_obj_tree_scrollable(page_c, LV_DIR_LEFT, &obj_scrollable,
                                              &obj_dist))
            {
                LV_LOG_INFO("obj_scrollable:%p", obj_scrollable);
    ...
    if ((enc_dir & (LV_DIR_BOTTOM | LV_DIR_RIGHT)) != 0)
    {
        ...
        if ((enc_dir & LV_DIR_BOTTOM) != 0)
            if (lvgl_view_obj_tree_scrollable(page_c, LV_DIR_BOTTOM, &obj_scrollable,
                                              &obj_dist))
            {
                LV_LOG_INFO("obj_scrollable:%p", obj_scrollable);
                lv_obj_scroll_by(obj_scrollable, 0, +LV_MIN(obj_diff_y, obj_dist), true);
        ...
        if ((enc_dir & LV_DIR_RIGHT) != 0)
            if (lvgl_view_obj_tree_scrollable(page_c, LV_DIR_RIGHT, &obj_scrollable,
                                              &obj_dist))
            {
                LV_LOG_INFO("obj_scrollable:%p", obj_scrollable);
                lv_obj_scroll_by(obj_scrollable, +LV_MIN(obj_diff_x, obj_dist), 0, true);
