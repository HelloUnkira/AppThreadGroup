...
void app_lv_ui_func_local_error_print(const char *error_string)
{
...
/*@brief lvgl ui数据交互回调
 */
static bool app_lv_ui_func_local_math_expression(char *expression, double *result, char *error_string)
{
    /* 外部引用 */
    bool retval = CalculatorMathExpression(expression, result, app_lv_ui_func_local_error_print);
...
app_lv_ui_presenter_calculator_t app_lv_ui_presenter_calculator = {
    .math_expression = app_lv_ui_func_local_math_expression,
};
