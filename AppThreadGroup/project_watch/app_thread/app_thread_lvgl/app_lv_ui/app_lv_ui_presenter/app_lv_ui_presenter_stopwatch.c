...
/*@brief lvgl ui数据交互回调
 */
static void app_lv_ui_func_local_get_tick_main(app_lv_ui_stopwatch_t *stopwatch)
{
...
/*@brief lvgl ui数据交互回调
 */
static void app_lv_ui_func_local_get_tick_list(app_lv_ui_stopwatch_t **stopwatch)
{
...
/*@brief lvgl ui数据交互回调
 */
static uint8_t app_lv_ui_func_local_get_tick_num(void)
{
...
/*@brief lvgl ui数据交互回调
 */
static void app_lv_ui_func_local_clean_tick_list(void)
{
...
/*@brief lvgl ui数据交互回调
 */
static void app_lv_ui_func_local_refr_tick_list(void)
{
...
app_lv_ui_presenter_stopwatch_t app_lv_ui_presenter_stopwatch = {
    .get_tick_main      = app_lv_ui_func_local_get_tick_main,
    .get_tick_list      = app_lv_ui_func_local_get_tick_list,
    .get_tick_num       = app_lv_ui_func_local_get_tick_num,
    .refr_tick_list     = app_lv_ui_func_local_refr_tick_list,
    .clean_tick_list    = app_lv_ui_func_local_clean_tick_list,
