...
/*@brief 界面默认事件响应回调
 */
static void app_lv_event_ui_img_center_cb(lv_event_t *e)
{
    switch (lv_event_get_code(e)) {
...
void app_lv_ui_star_robit_show(void *scene)
{
    if (app_lv_ui_res_local == NULL) {
        ...
        lv_obj_add_event_cb(app_lv_ui_res_local->img_center, app_lv_event_ui_img_center_cb, LV_EVENT_ALL, NULL);
