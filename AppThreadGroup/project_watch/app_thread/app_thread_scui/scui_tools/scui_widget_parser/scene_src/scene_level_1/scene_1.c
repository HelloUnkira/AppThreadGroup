...
static inline void scui_ui_scene_window_float_cfg(void)
{
    ...
    float_cfg.main = SCUI_UI_SCENE_1;
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_1_c_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_1_lu_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_1_ru_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_1_ld_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_1_rd_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
