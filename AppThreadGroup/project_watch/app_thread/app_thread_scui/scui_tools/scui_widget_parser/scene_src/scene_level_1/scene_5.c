...
static inline void scui_ui_scene_window_float_cfg(void)
{
    ...
    float_cfg.main = SCUI_UI_SCENE_5;
...
static inline void scui_ui_scene_window_list_cfg(void)
{
    ...
    scui_window_cfg_get(SCUI_UI_SCENE_5, &window_cfg);
    ...
    scui_window_cfg_set(SCUI_UI_SCENE_5, &window_cfg);
}
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_5_event_proc(scui_event_t *event)
{
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_5_c_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_5_lu_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_5_ru_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_5_ld_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
 ...
 *@retval 事件响应状态
 */
scui_event_retval_t scui_ui_scene_5_rd_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse:
        /* 这个事件可以视为本控件的全局刷新帧动画 */
