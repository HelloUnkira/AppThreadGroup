...
void scui_ui_scene_home_window_float_cfg(void)
{
    /* 窗口属性参数配置 */
...
void scui_ui_scene_home_window_list_cfg(void)
{
    /* 窗口属性参数配置 */
...
scui_event_retval_t scui_ui_scene_home_event_proc(scui_event_t *event)
{
    ...
    case scui_event_show:
        ...
        scui_ui_scene_home_window_float_cfg();
        scui_ui_scene_home_window_list_cfg();
        return scui_event_retval_keep;
