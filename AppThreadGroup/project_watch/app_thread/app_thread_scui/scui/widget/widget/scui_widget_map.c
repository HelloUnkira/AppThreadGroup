...
void scui_widget_map_find(scui_widget_type_t type, scui_widget_map_t **widget_map)
{
    ...
    static const scui_widget_map_t scui_widget_map[scui_widget_type_num] = {
        ...
        [scui_widget_type_inchar] = {
            .size    = sizeof(scui_inchar_t),
            .maker   = sizeof(scui_inchar_maker_t),
            .base    = scui_widget_type_string,
            .make    = scui_inchar_make,
            .burn    = scui_inchar_burn,
            .invoke  = scui_inchar_invoke,
            .inherit = false,
            .name    = "inchar",
        },
        ...
        [scui_widget_type_obj_btn] = {
            .size    = sizeof(scui_obj_btn_t),
            .maker   = sizeof(scui_obj_btn_maker_t),
            .base    = scui_widget_type_object,
            .make    = scui_obj_btn_make,
            .burn    = scui_obj_btn_burn,
            .invoke  = scui_obj_btn_invoke,
            .inherit = true,
            .name    = "obj_btn",
        },
        [scui_widget_type_obj_arc] = {
            .size    = sizeof(scui_obj_arc_t),
            .maker   = sizeof(scui_obj_arc_maker_t),
            .base    = scui_widget_type_object,
            .make    = scui_obj_arc_make,
            .burn    = scui_obj_arc_burn,
            .invoke  = scui_obj_arc_invoke,
            .inherit = true,
            .name    = "obj_arc",
        },
        [scui_widget_type_obj_bar] = {
            .size    = sizeof(scui_obj_bar_t),
            .maker   = sizeof(scui_obj_bar_maker_t),
            .base    = scui_widget_type_object,
            .make    = scui_obj_bar_make,
            .burn    = scui_obj_bar_burn,
            .invoke  = scui_obj_bar_invoke,
            .inherit = true,
            .name    = "obj_bar",
        },
        [scui_widget_type_obj_chart] = {
            .size    = sizeof(scui_obj_chart_t),
            .maker   = sizeof(scui_obj_chart_maker_t),
            .base    = scui_widget_type_object,
            .make    = scui_obj_chart_make,
            .burn    = scui_obj_chart_burn,
            .invoke  = scui_obj_chart_invoke,
            .inherit = true,
            .name    = "obj_chart",
        },
        [scui_widget_type_obj_slider] = {
            .size    = sizeof(scui_obj_slider_t),
            .maker   = sizeof(scui_obj_slider_maker_t),
            .base    = scui_widget_type_obj_bar,
            .make    = scui_obj_slider_make,
            .burn    = scui_obj_slider_burn,
            .invoke  = scui_obj_slider_invoke,
            .inherit = true,
            .name    = "obj_slider",
        },
        [scui_widget_type_obj_switch] = {
            .size    = sizeof(scui_obj_switch_t),
            .maker   = sizeof(scui_obj_switch_maker_t),
            .base    = scui_widget_type_obj_bar,
            .make    = scui_obj_switch_make,
            .burn    = scui_obj_switch_burn,
            .invoke  = scui_obj_switch_invoke,
            .inherit = true,
            .name    = "obj_switch",
        },
        [scui_widget_type_obj_spinner] = {
            .size    = sizeof(scui_obj_spinner_t),
            .maker   = sizeof(scui_obj_spinner_maker_t),
            .base    = scui_widget_type_obj_arc,
            .make    = scui_obj_spinner_make,
            .burn    = scui_obj_spinner_burn,
            .invoke  = scui_obj_spinner_invoke,
            .inherit = true,
            .name    = "obj_spinner",
        },
    };
