...
void scui_widget_map_find(scui_widget_type_t type, scui_widget_map_t **widget_map)
{
    ...
    static const scui_widget_map_t scui_widget_map[scui_widget_type_num] = {
        ...
        [scui_widget_type_linear_m] = {
            .size    = sizeof(scui_linear_m_t),
            .maker   = sizeof(scui_linear_m_maker_t),
            .base    = scui_widget_type_linear_m,
            .make    = scui_linear_m_make,
            .burn    = scui_linear_m_burn,
            .invoke  = scui_linear_m_invoke,
            .inherit = false,
            .name    = "linear_m",
        },
        [scui_widget_type_linear_s] = {
            .size    = sizeof(scui_linear_s_t),
            .maker   = sizeof(scui_linear_s_maker_t),
            .base    = scui_widget_type_linear_s,
            .make    = scui_linear_s_make,
            .burn    = scui_linear_s_burn,
            .invoke  = scui_linear_s_invoke,
            .inherit = false,
            .name    = "linear_s",
        },
