...
void scui_roller_layout(scui_handle_t handle)
{
    ...
    scui_widget_map_find(scui_widget_type_roller, &widget_map);
...
static void scui_roller_m_event(scui_event_t *event)
{
    ...
    case scui_event_draw: {
        ...
        scui_linear_draw_idx(widget->myself, &draw_idx);
        scui_linear_s_item(widget->myself, &handle_s, draw_idx);
    ...
    case scui_event_ptr_click: {
        ...
        scui_linear_m_item(parent, &handle_m, index);
...
void scui_roller_string_str(scui_handle_t handle, scui_string_maker_t *maker, uint8_t *str_utf8)
{
    ...
    scui_linear_m_item(handle, &handle_m, idx);
    *handle_m = custom_handle;
    ...
    scui_linear_s_item(handle, &handle_s, idx);
