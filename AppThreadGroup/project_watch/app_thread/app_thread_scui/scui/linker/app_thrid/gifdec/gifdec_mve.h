...
static inline void _gifdec_fill_bg_mve(uint8_t *dst, uint16_t w, uint16_t h,
                                       ...
                                       uint8_t opa)
{
    scui_color8888_t color8888 = {0};
    color8888.ch.r = color[0];
    color8888.ch.g = color[1];
    color8888.ch.b = color[2];
    color8888.ch.a = opa;
    
    uint32_t color_32 = color8888.full;
...
static inline void _gifdec_render_frame_mve(uint8_t *dst, uint16_t w, uint16_t h,
                                            uint16_t stride, uint8_t *frame,
