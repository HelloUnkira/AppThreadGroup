 ...
 *@param draw_dsc 绘制描述符实例
 */
void scui_draw_ctx_image_2d(scui_draw_dsc_t *draw_dsc)
{
    /* draw dsc args<s> */
    scui_surface_t *dst_surface =  draw_dsc->image_2d.dst_surface;
    scui_area_t    *dst_clip    = &draw_dsc->image_2d.dst_clip;
    scui_image_t   *src_image   =  draw_dsc->image_2d.src_image;
    scui_area_t    *src_clip    = &draw_dsc->image_2d.src_clip;
    scui_alpha_t    src_alpha   =  draw_dsc->image_2d.src_alpha;
    scui_color_t    src_color   =  draw_dsc->image_2d.src_color;
    scui_point_t   *src_scale   = &draw_dsc->image_2d.src_scale;
    scui_multi_t    src_angle   =  draw_dsc->image_2d.src_angle;
    scui_point_t   *dst_anchor  = &draw_dsc->image_2d.dst_anchor;
    scui_point_t   *src_center  = &draw_dsc->image_2d.src_center;
    /* draw dsc args<e> */
    /* */
    SCUI_ASSERT(dst_surface != NULL && dst_surface->pixel != NULL && dst_clip != NULL);
    SCUI_ASSERT(src_image != NULL && src_clip != NULL);
    ...
    scui_draw_area_2d_blend(true, dst_surface, *dst_clip,
        &image_surface, *src_clip, src_color, *src_scale, src_angle,
    ...
    scui_matrix_translate(&src_matrix, &(scui_point2_t){.x = +dst_anchor->x, .y = +dst_anchor->y,});
    ...
    scui_draw_3d_blend(true, dst_surface, *dst_clip,
 ...
 *@param draw_dsc 绘制描述符实例
 */
void scui_draw_ctx_image_3d(scui_draw_dsc_t *draw_dsc)
{
    /* draw dsc args<s> */
    scui_surface_t *dst_surface =  draw_dsc->image_3d.dst_surface;
    scui_area_t    *dst_clip    = &draw_dsc->image_3d.dst_clip;
    scui_image_t   *src_image   =  draw_dsc->image_3d.src_image;
    scui_area_t    *src_clip    = &draw_dsc->image_3d.src_clip;
    scui_alpha_t    src_alpha   =  draw_dsc->image_3d.src_alpha;
    scui_color_t    src_color   =  draw_dsc->image_3d.src_color;
    scui_matrix_t  *inv_matrix  = &draw_dsc->image_3d.inv_matrix;
    scui_matrix_t  *src_matrix  = &draw_dsc->image_3d.src_matrix;
    /* draw dsc args<e> */
    /* */
    SCUI_ASSERT(dst_surface != NULL && dst_surface->pixel != NULL && dst_clip != NULL);
    SCUI_ASSERT(src_image != NULL && src_clip != NULL);
