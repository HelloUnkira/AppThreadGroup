...
bool scui_draw_ctx_acc_sched(scui_draw_dsc_t *draw_dsc)
{
    ...
    void scui_draw_ctx_acc_area_fill_grad(scui_draw_dsc_t *draw_dsc);
    void scui_draw_ctx_acc_area_fill_grads(scui_draw_dsc_t *draw_dsc);
    void scui_draw_ctx_acc_area_copy(scui_draw_dsc_t *draw_dsc);
    void scui_draw_ctx_acc_area_blend(scui_draw_dsc_t *draw_dsc);
    void scui_draw_ctx_acc_area_alpha_filter(scui_draw_dsc_t *draw_dsc);
    ...
    static const scui_draw_ctx_acc_cb_t scui_draw_ctx_acc_cb[scui_draw_type_num] = {
        ...
        [scui_draw_type_area_fill_grad] =           scui_draw_ctx_acc_area_fill_grad,
        [scui_draw_type_area_fill_grads] =          scui_draw_ctx_acc_area_fill_grads,
        [scui_draw_type_area_copy] =                scui_draw_ctx_acc_area_copy,
        [scui_draw_type_area_blend] =               scui_draw_ctx_acc_area_blend,
        [scui_draw_type_area_alpha_filter] =        scui_draw_ctx_acc_area_alpha_filter,
