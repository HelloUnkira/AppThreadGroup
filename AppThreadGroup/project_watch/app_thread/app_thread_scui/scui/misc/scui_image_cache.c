...
static uint32_t scui_image_cache_fd_t(scui_table_dln_t *node)
{
    ...
    scui_image_unit_t *image_unit = scui_own_ofs(scui_image_unit_t, lru_unit, unit);
...
static bool scui_image_cache_fc_t(scui_table_dln_t *node1, scui_table_dln_t *node2)
{
    ...
    scui_image_unit_t *image_unit1 = scui_own_ofs(scui_image_unit_t, lru_unit, unit1);
    scui_image_unit_t *image_unit2 = scui_own_ofs(scui_image_unit_t, lru_unit, unit2);
...
/*@brief 节点占用回调
 */
static scui_multi_t scui_image_unit_get_size(scui_cache_lru_unit_t *unit)
{
    scui_image_unit_t *image_unit = scui_own_ofs(scui_image_unit_t, lru_unit, unit);
...
/*@brief 节点销毁回调
 */
static void scui_image_unit_new_node(scui_cache_lru_unit_t **unit, scui_cache_lru_unit_t *unit_t)
{
    scui_image_unit_t *image_unit_t = scui_own_ofs(scui_image_unit_t, lru_unit, unit_t);
    scui_image_unit_t *image_unit = SCUI_MEM_ALLOC(scui_mem_type_mix, sizeof(scui_image_unit_t));
...
/*@brief 节点销毁回调
 */
static void scui_image_unit_cpy_node(scui_cache_lru_unit_t *unit, scui_cache_lru_unit_t *unit_t)
{
    scui_image_unit_t *image_unit_t = scui_own_ofs(scui_image_unit_t, lru_unit, unit_t);
    scui_image_unit_t *image_unit   = scui_own_ofs(scui_image_unit_t, lru_unit, unit);
...
/*@brief 节点创建回调
 */
static void scui_image_unit_del_node(scui_cache_lru_unit_t  *unit)
{
    scui_image_unit_t *image_unit = scui_own_ofs(scui_image_unit_t, lru_unit, unit);
    /* 图片资源卸载 */
...
void scui_image_cache_ready(void)
{
    ...
    cache->lru_table.dlt_fd = scui_image_cache_fd_t;
    cache->lru_table.dlt_fc = scui_image_cache_fc_t;
    cache->lru_table.dlt_fv = scui_image_cache_fv_t;
    cache->lru_table.ht_list_num = SCUI_CACHE_HASH_IMAGE;
    cache->lru_table.total = SCUI_CACHE_TOTAL_IMAGE;
    cache->lru_table.get_size = scui_image_unit_get_size;
    cache->lru_table.new_node = scui_image_unit_new_node;
    cache->lru_table.cpy_node = scui_image_unit_cpy_node;
    cache->lru_table.del_node = scui_image_unit_del_node;
