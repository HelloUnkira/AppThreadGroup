 ...
 *@param event 事件
 */
void scui_test_ui_misc_slider_event_proc(scui_event_t *event)
{
    switch (event->type) {
 ...
 *@param event 事件
 */
void scui_test_ui_misc_spinner_event_proc(scui_event_t *event)
{
    switch (event->type) {
    case scui_event_anima_elapse: {
        scui_custom_data_t *data = NULL;
...
void scui_test_ui_misc_event_proc(scui_event_t *event)
{
    ...
    case scui_event_create: {
        ...
        custom_maker.widget.event_cb = scui_test_ui_misc_spinner_event_proc;
        scui_widget_create(&custom_maker, &custom_handle);
        #endif
