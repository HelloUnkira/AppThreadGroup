 ...
 *@param event 事件
 */
static void scui_ui_scene_mini_card_item_event(scui_event_t *event)
{
    switch (event->type) {
    ...
    case scui_event_draw_graph: {
        ...
        case scui_ui_scene_mini_card_type_music_control: {
            scui_handle_t image = scui_image_prj_wgt_music_01_bg;
        ...
        case scui_ui_scene_mini_card_type_daily_exercise: {
            // 三环绘制
            scui_handle_t image_bg   = scui_image_prj_wgt_act_01_bg;
            scui_handle_t image_edge = scui_image_prj_wgt_act_04_dot;
            scui_handle_t image_ring = scui_image_prj_wgt_act_05_ring;
            ...
            clip_fg.w = scui_image_w(image_ring); clip_fg.h = scui_image_h(image_ring);
            ...
            clip_icon_step.w = scui_image_w(image_icon_step); clip_icon_step.h = scui_image_h(image_icon_step);
            scui_area_t clip_icon_dist = {.x = 25, .y = 123,};
            clip_icon_dist.w = scui_image_w(image_icon_dist); clip_icon_dist.h = scui_image_h(image_icon_dist);
        ...
        case scui_ui_scene_mini_card_type_music_control: {
            ...
            // 在绘制中顺便更新词条
            scui_string_update_text(scui_ui_res_local->title_music, SCUI_LANG_IDX_0X010b);
            
            // 不同状态显示不同图标
            scui_handle_t image0 = scui_image_prj_wgt_music_04_up;
            scui_handle_t image1 = scui_image_prj_wgt_music_05_paused;
            scui_handle_t image2 = scui_image_prj_wgt_music_02_next;
            
            scui_area_t btn_clip_0 = {.x = 60, .y = 99,};
            btn_clip_0.w = scui_image_w(image0); btn_clip_0.h = scui_image_h(image0);
            scui_area_t btn_clip_1 = {.x = 160, .y = 77,};
            btn_clip_1.w = scui_image_w(image1); btn_clip_1.h = scui_image_h(image1);
            scui_area_t btn_clip_2 = {.x = 308, .y = 99,};
            btn_clip_2.w = scui_image_w(image2); btn_clip_2.h = scui_image_h(image2);
        ...
        case scui_ui_scene_mini_card_type_stress: {
            ...
            scui_handle_t image = scui_image_prj_wgt_06_retry;
            ...
            if (type == scui_ui_scene_mini_card_type_hr) {
                unit_text = SCUI_LANG_IDX_0X0021;
                
                scui_lang_type_t lang_type = 0;
                scui_lang_get(&lang_type);
                const char *lang_str = scui_lang_str(unit_text, lang_type);
            ...
            if (type == scui_ui_scene_mini_card_type_stress) {
                unit_text = SCUI_LANG_IDX_0X004e;
                if (scui_presenter.get_stress_cur() < 70) unit_text = SCUI_LANG_IDX_0X004d;
                if (scui_presenter.get_stress_cur() < 50) unit_text = SCUI_LANG_IDX_0X004c;
                if (scui_presenter.get_stress_cur() < 30) unit_text = SCUI_LANG_IDX_0X004b;
            ...
            if (passby_last < 1) unit_text = SCUI_LANG_IDX_0X001d;
            else if (passby_last < 59) unit_text = SCUI_LANG_IDX_0X001e;
            else if (passby_last < 60 * 24) unit_text = SCUI_LANG_IDX_0X001f;
            else if (passby_last < 60 * 24 * 7) unit_text = SCUI_LANG_IDX_0X0020;
            else unit_text = SCUI_LANG_IDX_0X01c4;
        ...
        case scui_ui_scene_mini_card_type_weather: {
            ...
            scui_area_t image_clip = {.x = 346, .y = 69,};
            image_clip.w = scui_image_w(image); image_clip.h = scui_image_h(image);
            scui_widget_draw_image(event->object, &image_clip, image, NULL, SCUI_COLOR_UNUSED);
        ...
        case scui_ui_scene_mini_card_type_alarm: {
            ...
            if (scui_presenter.alarm_none()) {
                ...
                if (scui_presenter.alarm_near_state()) {
                    ...
                    image_on_clip.w = scui_image_w(image_on); image_on_clip.h = scui_image_h(image_on);
                    scui_widget_draw_image(event->object, &image_on_clip, image_on, NULL, SCUI_COLOR_UNUSED);
                    scui_area_t image_dot_clip = {.x = 346, .y = 74,};
                    image_dot_clip.w = scui_image_w(image_dot); image_dot_clip.h = scui_image_h(image_dot);
                    scui_widget_draw_image(event->object, &image_dot_clip, image_dot, NULL, SCUI_COLOR_UNUSED);
                } else {
                    scui_area_t image_on_clip = {.x = 316, .y = 71,};
                    image_on_clip.w = scui_image_w(image_on); image_on_clip.h = scui_image_h(image_on);
                    scui_widget_draw_image(event->object, &image_on_clip, image_on, NULL, SCUI_COLOR_UNUSED);
                    scui_area_t image_dot_clip = {.x = 319, .y = 74,};
                    image_dot_clip.w = scui_image_w(image_dot); image_dot_clip.h = scui_image_h(image_dot);
                    scui_widget_draw_image(event->object, &image_dot_clip, image_dot, NULL, SCUI_COLOR_UNUSED);
                }
                ...
                if ((scui_presenter.alarm_near_date() & 0x1000) != 0)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_IDX_0X00c5, lang_type));
                if ((scui_presenter.alarm_near_date() & 0x2000) != 0)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_IDX_0X00f8, lang_type));
                if ((scui_presenter.alarm_near_date() & 0x8000) != 0)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_IDX_0X00f2, lang_type));
                if ((scui_presenter.alarm_near_date() & 0x7f) == 0x7f)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_IDX_0X00f1, lang_type));
                
                if (strlen(data_unit) == 0)
                if ((scui_presenter.alarm_near_date() & 0x7f) != 0) {
                    uint32_t text_week[] = {
                        SCUI_LANG_IDX_0X006d, /* 周日 */
                        SCUI_LANG_IDX_0X0067, /* 周一 */
                        SCUI_LANG_IDX_0X0068, /* 周二 */
                        SCUI_LANG_IDX_0X0069, /* 周三 */
                        SCUI_LANG_IDX_0X006a, /* 周四 */
                        SCUI_LANG_IDX_0X006b, /* 周五 */
                        SCUI_LANG_IDX_0X006c, /* 周六 */
                    };
                    ...
                    for (uint8_t idx = 0; idx < 7; idx++) {
                        if ((week & (1 << idx)) == 0)
                            continue;
                        snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                            "%s ", scui_lang_str(text_week[idx], lang_type));
                    }
                }
        ...
        case scui_ui_scene_mini_card_type_sleep: {
            ...
            if (scui_presenter.sleep_none()) {
                ...
                scui_handle_t image_l = scui_image_prj_sleep_home_bar_03_grey_00;
                scui_handle_t image_r = scui_image_prj_sleep_home_bar_04_grey_01;
                ...
                image_clip_r.w = scui_image_w(image_r); image_clip_r.h = scui_image_h(image_r);
                ...
                scui_area_t image_clip_c = {.x = 28 + scui_image_w(image_l), .y = 137,};
                image_clip_c.w = width - scui_image_w(image_l) - scui_image_w(image_r);
                image_clip_c.h = scui_image_h(image_l);
                ...
                snprintf(data_unit, sizeof(data_unit), "%02d%s%02d%s",
                    scui_presenter.sleep_hour(),   scui_lang_str(SCUI_LANG_IDX_0X013b, lang_type),
                    scui_presenter.sleep_minute(), scui_lang_str(SCUI_LANG_IDX_0X013c, lang_type));
                ...
                scui_handle_t image_l4[4] = {
                    scui_image_prj_sleep_home_bar_09_zi_00,
                    scui_image_prj_sleep_home_bar_01_blue_00,
                    scui_image_prj_sleep_home_bar_07_qing_00,
                    scui_image_prj_sleep_home_bar_05_prange_00,
                };
                scui_handle_t image_r4[4] = {
                    scui_image_prj_sleep_home_bar_10_zi_01,
                    scui_image_prj_sleep_home_bar_02_blue_01,
                    scui_image_prj_sleep_home_bar_08_qing_01,
                    scui_image_prj_sleep_home_bar_06_prange_01,
                };
                ...
                for (uint8_t idx = 0; idx < 4; idx++) {
                    ...
                    scui_area_t image_clip_l = {.x = pos_x4[idx], .y = 137,};
                    image_clip_l.w = scui_image_w(image_l); image_clip_l.h = scui_image_h(image_l);
                    scui_area_t image_clip_r = {.x = pos_x4[idx] + width4[idx] - scui_image_w(image_r), .y = 137,};
                    image_clip_r.w = scui_image_w(image_r); image_clip_r.h = scui_image_h(image_r);
                    scui_widget_draw_image(event->object, &image_clip_l, image_l, NULL, SCUI_COLOR_UNUSED);
                    scui_widget_draw_image(event->object, &image_clip_r, image_r, NULL, SCUI_COLOR_UNUSED);
                    scui_area_t image_clip_c = {.x = pos_x4[idx] + scui_image_w(image_l), .y = 137,};
        ...
        case scui_ui_scene_mini_card_type_sport_record: {
            ...
            if (scui_presenter.sport_record_none()) {
                ...
                char data_unit[50] = {0};
                snprintf(data_unit, sizeof(data_unit), "%02d%s%02d%s",
                    scui_presenter.sport_record_hour(),   scui_lang_str(SCUI_LANG_IDX_0X013b, lang_type),
                    scui_presenter.sport_record_minute(), scui_lang_str(SCUI_LANG_IDX_0X013c, lang_type));
        ...
        case scui_ui_scene_mini_card_type_women_health: {
            ...
            if (scui_presenter.women_health_none()) {
                ...
                char data_unit[50] = {0};
                snprintf(data_unit, sizeof(data_unit), "%02d%s%02d%s",
                    scui_presenter.women_health_hour(),   scui_lang_str(SCUI_LANG_IDX_0X013b, lang_type),
                    scui_presenter.women_health_minute(), scui_lang_str(SCUI_LANG_IDX_0X013c, lang_type));
        ...
        case scui_ui_scene_mini_card_type_compass: {
            ...
            /* 指北针背景表图 */
            scui_handle_t image = scui_image_prj_wgt_cmps_02_bg;
            ...
            if (scui_presenter.compass_invalid()) {
                ...
                scui_widget_draw_image_rotate(event->object, NULL, image, NULL, SCUI_COLOR_UNUSED, anchor, center,
                    scui_presenter.compass_angle() * SCUI_SCALE_COF);
                ...
                } dir_table[] =
                {
                    ...
                    { (315) + (45 / 2), (0)   + (45 / 2), SCUI_LANG_IDX_0X011e },
                    { (0)   + (45 / 2), (45)  + (45 / 2), SCUI_LANG_IDX_0X0123 },
                    { (45)  + (45 / 2), (90)  + (45 / 2), SCUI_LANG_IDX_0X0121 },
                    { (90)  + (45 / 2), (135) + (45 / 2), SCUI_LANG_IDX_0X0122 },
                    { (135) + (45 / 2), (180) + (45 / 2), SCUI_LANG_IDX_0X0120 },
                    { (180) + (45 / 2), (225) + (45 / 2), SCUI_LANG_IDX_0X0125 },
                    { (225) + (45 / 2), (270) + (45 / 2), SCUI_LANG_IDX_0X011f },
                    { (270) + (45 / 2), (315) + (45 / 2), SCUI_LANG_IDX_0X0124 }
                };
        ...
        case scui_ui_scene_mini_card_type_altimeter: {
            ...
            scui_area_t color_clip = {.x = 204, .y = 85, .w = 2, .h = 68,};
        ...
        case scui_ui_scene_mini_card_type_countdown: {
            ...
            scui_lang_type_t lang_type = 0;
            scui_lang_get(&lang_type);
            const char *lang_str = scui_lang_str(SCUI_LANG_IDX_0X013c, lang_type);
            
            scui_handle_t image = scui_image_prj_wgt_tmr_01_bg;
        ...
        case scui_ui_scene_mini_card_type_world_time: {
            ...
            /* 背景图 */
            scui_handle_t image = scui_image_prj_wgt_02_bg;
    ...
    case scui_event_draw_buffer: {
        ...
        scui_area_t  qc_area = scui_widget_area(event->object);
        scui_area_t  qc_img  = scui_image_area(surface_image);
        scui_point_t anchor = scui_area_center(&qc_area);
        scui_point_t center = scui_area_center(&qc_img);
        scui_widget_draw_image_scale(event->object, &qc_area, surface_image, NULL, SCUI_COLOR_UNUSED, anchor, center, img_scale);
    ...
    case scui_event_create: {
        ...
        for (uint8_t idx = 0; idx < scui_ui_scene_mini_card_num; idx++) {
            ...
            case scui_ui_scene_mini_card_type_daily_exercise: {
                ...
                scui_handle_t image_icon_kcal  = scui_image_prj_wgt_act_02_cal;
                scui_handle_t image_digit_kcal = scui_image_prj_wgt_act_num_pink_04_03;
                ximage_maker.widget.clip     = SCUI_AREA_MAKE_BM(25 + scui_image_w(image_icon_kcal) + 10, 23, (scui_image_w(image_icon_kcal) + 10) * 5, scui_image_h(image_digit_kcal));
                ...
                scui_handle_t image_icon_step  = scui_image_prj_wgt_act_08_steps;
                scui_handle_t image_digit_step = scui_image_prj_wgt_act_num_yellow_04_03;
                ximage_maker.widget.clip     = SCUI_AREA_MAKE_BM(25 + scui_image_w(image_icon_step) + 10, 73, (scui_image_w(image_icon_step) + 10) * 5, scui_image_h(image_digit_step));
                scui_widget_create(&ximage_maker, &ximage_handle);
                ...
                scui_handle_t image_icon_dist  = scui_image_prj_wgt_act_03_dist;
                scui_handle_t image_digit_dist = scui_image_prj_wgt_act_num_blue_04_03;
                ximage_maker.widget.clip     = SCUI_AREA_MAKE_BM(25 + scui_image_w(image_icon_dist) + 10, 123, (scui_image_w(image_icon_dist) + 10) * 5, scui_image_h(image_digit_dist));
                scui_widget_create(&ximage_maker, &ximage_handle);
            ...
            case scui_ui_scene_mini_card_type_music_control: {
                ...
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFFFFFF, 0xFFFFFFFF);
                string_t_maker.text = SCUI_LANG_IDX_0X0176;
            ...
            case scui_ui_scene_mini_card_type_stress: {
                ...
                scui_string_maker_t string_t_maker = string_maker;
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                
                if (type == scui_ui_scene_mini_card_type_hr) {
                    string_t_maker.args.color = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFF0000, 0xFFFF0000);
                    string_t_maker.text = SCUI_LANG_IDX_0X0019;
                }
                if (type == scui_ui_scene_mini_card_type_spo2) {
                    string_t_maker.args.color = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFF0000, 0xFFFF0000);
                    string_t_maker.text = SCUI_LANG_IDX_0X0040;
                }
                if (type == scui_ui_scene_mini_card_type_stress) {
                    string_t_maker.args.color = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF00F4EA, 0xFF00F4EA);
                    string_t_maker.text = SCUI_LANG_IDX_0X0049;
                }
                ...
                string_t_maker.args.color  = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF4D4D4D, 0xFF4D4D4D);
                scui_widget_create(&string_t_maker, &string_handle);
                scui_string_update_str(string_handle, "");
            ...
            case scui_ui_scene_mini_card_type_weather: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF06AEFF, 0xFF06AEFF);
                string_t_maker.text = SCUI_LANG_IDX_0X0092;
            ...
            case scui_ui_scene_mini_card_type_alarm: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFDE8926, 0xFFDE8926);
                string_t_maker.text = SCUI_LANG_IDX_0X00e6;
                ...
                if (scui_presenter.alarm_none()) {
                    string_t_maker.widget.clip.y = 69;
                    string_t_maker.args.color  = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF4D4D4D, 0xFF4D4D4D);
                    string_t_maker.text = SCUI_LANG_IDX_0X00f0;
                    scui_widget_create(&string_t_maker, &string_handle);
                    ...
                    string_t_maker.widget.clip.y  = 129;
                    string_t_maker.args.color    = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF4D4D4D, 0xFF4D4D4D);
                    string_t_maker.text = SCUI_LANG_IDX_0X00e7;
                    scui_widget_create(&string_t_maker, &string_handle);
                    #endif
                } else {
                    string_t_maker.widget.clip.y = 69;
            ...
            case scui_ui_scene_mini_card_type_sleep: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF06E2ED, 0xFF06E2ED);
                string_t_maker.text = SCUI_LANG_IDX_0X004f;
                ...
                if (scui_presenter.sleep_none()) {
                    ...
                    string_t_maker.widget.clip.y = 69;
                    string_t_maker.args.color  = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFFFFFF, 0xFFFFFFFF);
                    string_t_maker.text = SCUI_LANG_IDX_0X0051;
                    scui_widget_create(&string_t_maker, &string_handle);
            ...
            case scui_ui_scene_mini_card_type_sport_record: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFF83600, 0xFFF83600);
                string_t_maker.text = SCUI_LANG_IDX_0X01c5;
                ...
                if (scui_presenter.sport_record_none()) {
                    ...
                    string_t_maker.widget.clip.y = 69;
                    string_t_maker.args.color  = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFFFFFF, 0xFFFFFFFF);
                    string_t_maker.text = SCUI_LANG_IDX_0X01c4;
                    scui_widget_create(&string_t_maker, &string_handle);
            ...
            case scui_ui_scene_mini_card_type_women_health: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFD83371, 0xFFD83371);
                string_t_maker.text = SCUI_LANG_IDX_0X0110;
            ...
            case scui_ui_scene_mini_card_type_compass: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFD2627, 0xFFFD2627);
                string_t_maker.text = SCUI_LANG_IDX_0X011c;
                ...
                if (scui_presenter.compass_invalid()) {
                    ...
                    string_t_maker.widget.clip.y = 129;
                    string_t_maker.args.color    = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF4D4D4D, 0xFF4D4D4D);
                    string_t_maker.text = SCUI_LANG_IDX_0X00f6;
                    scui_widget_create(&string_t_maker, &string_handle);
                    #endif
                } else {
            ...
            case scui_ui_scene_mini_card_type_altimeter: {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF98FF02, 0xFF98FF02);
                string_t_maker.text = SCUI_LANG_IDX_0X012a;
                
                scui_widget_create(&string_t_maker, &string_handle);
                
                string_t_maker.widget.clip  = SCUI_AREA_MAKE_BM(36, 77, 410 / 2 - 36 * 2, 36);
                ...
                string_t_maker.widget.clip  = SCUI_AREA_MAKE_BM(410 / 2 + 36, 77, 410 / 2 - 36 * 2, 36);
                string_t_maker.args.align_hor = 2;
                string_t_maker.args.color   = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFFFFFFF, 0xFFFFFFFF);
                scui_widget_create(&string_t_maker, &string_handle);
                scui_string_update_str(string_handle, "");
                ...
                string_t_maker.widget.clip  = SCUI_AREA_MAKE_BM(36, 127, 410 / 2 - 36 * 2, 36);
                string_t_maker.args.align_hor = 2;
                string_t_maker.text = SCUI_LANG_IDX_0X0127;
                string_t_maker.args.color   = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF4D4D4D, 0xFF4D4D4D);
                scui_widget_create(&string_t_maker, &string_handle);
                
                string_t_maker.widget.clip  = SCUI_AREA_MAKE_BM(410 / 2 + 36, 127, 410 / 2 - 36 * 2, 36);
                string_t_maker.args.align_hor = 2;
                string_t_maker.text = SCUI_LANG_IDX_0X0126;
                string_t_maker.args.color   = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF4D4D4D, 0xFF4D4D4D);
                scui_widget_create(&string_t_maker, &string_handle);
            ...
            case scui_ui_scene_mini_card_type_stopwatch : {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF00E85E, 0xFF00E85E);
                string_t_maker.text = SCUI_LANG_IDX_0X013f;
                ...
                ximage_maker.widget.parent = item_handle;
                ximage_maker.widget.clip = SCUI_AREA_MAKE_BM(24, 69, (scui_image_w(image_digit) + 3) * 8, scui_image_h(image_digit));
                scui_widget_create(&ximage_maker, &ximage_handle);
            ...
            case scui_ui_scene_mini_card_type_countdown : {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFFDF7331, 0xFFDF7331);
                string_t_maker.text = SCUI_LANG_IDX_0X0139;
            ...
            case scui_ui_scene_mini_card_type_world_time : {
                ...
                string_t_maker.widget.clip       = SCUI_AREA_MAKE_BM(24, 22, 410 - 24 * 2, 40);
                string_t_maker.args.align_hor = 0;
                string_t_maker.args.color        = SCUI_COLOR_MAKE32_SE(true, 0, 0xFF1977FF, 0xFF1977FF);
                string_t_maker.text = SCUI_LANG_IDX_0X0140;
...
void scui_ui_scene_mini_card_event_proc(scui_event_t *event)
{
    ...
    case scui_event_create: {
        ...
        scui_widget_maker_linker(&scroll_maker.widget, 50, event->object);
        ...
        scroll_maker.widget.event_cb   = scui_ui_scene_mini_card_scroll_event;
