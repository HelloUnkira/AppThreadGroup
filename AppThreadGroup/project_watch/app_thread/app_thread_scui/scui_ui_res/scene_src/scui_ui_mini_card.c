...
static struct {
    ...
    scui_handle_t     linear_m[50];
    scui_handle_t     linear_s[50];
...
static void scui_ui_scene_item_s_event_proc(scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        for (uint8_t idx = 0; idx < scui_ui_scene_mini_card_num; idx++)
            if (scui_ui_res_local->linear_m[idx] == handle_m) {
                match_idx = idx;
                continue;
            }
        ...
        case scui_ui_scene_mini_card_type_daily_exercise: {
            ...
            scui_widget_draw_image(event->object, &clip_bg, false, image_bg, NULL, SCUI_COLOR_FILTER_TRANS);
            scui_widget_draw_ring(event->object, &clip_fg, false, image_ring, NULL, -81, color_kcal, +22, pct_kcal, image_edge);
            scui_widget_draw_ring(event->object, &clip_fg, false, image_ring, NULL, +39, color_step, +141, pct_step, image_edge);
            scui_widget_draw_ring(event->object, &clip_fg, false, image_ring, NULL, +158, color_dist, +262, pct_dist, image_edge);
            ...
            scui_widget_draw_image(event->object, &clip_icon_kcal, false, image_icon_kcal, NULL, SCUI_COLOR_FILTER_TRANS);
            scui_widget_draw_image(event->object, &clip_icon_step, false, image_icon_step, NULL, SCUI_COLOR_FILTER_TRANS);
            scui_widget_draw_image(event->object, &clip_icon_dist, false, image_icon_dist, NULL, SCUI_COLOR_FILTER_TRANS);
        ...
        case scui_ui_scene_mini_card_type_music_control: {
            ...
            scui_widget_draw_image(event->object, &btn_clip_0, false, image0, NULL, SCUI_COLOR_UNUSED);
            scui_widget_draw_image(event->object, &btn_clip_1, false, image1, NULL, SCUI_COLOR_UNUSED);
            scui_widget_draw_image(event->object, &btn_clip_2, false, image2, NULL, SCUI_COLOR_UNUSED);
        ...
        case scui_ui_scene_mini_card_type_stress: {
            ...
            scui_widget_draw_image(event->object, &image_clip, false, image, NULL, SCUI_COLOR_UNUSED);
            ...
            if (type == scui_ui_scene_mini_card_type_stress) {
                unit_text = SCUI_LANG_0X004e;
                if (scui_presenter.get_stress_cur() < 70) unit_text = SCUI_LANG_0X004d;
                if (scui_presenter.get_stress_cur() < 50) unit_text = SCUI_LANG_0X004c;
                if (scui_presenter.get_stress_cur() < 30) unit_text = SCUI_LANG_0X004b;
            ...
            if (passby_last < 1) unit_text = SCUI_LANG_0X001d;
            else if (passby_last < 59) unit_text = SCUI_LANG_0X001e;
            else if (passby_last < 60 * 24) unit_text = SCUI_LANG_0X001f;
            else if (passby_last < 60 * 24 * 7) unit_text = SCUI_LANG_0X0020;
            else unit_text = SCUI_LANG_0X01c4;
        ...
        case scui_ui_scene_mini_card_type_alarm: {
            ...
            if (scui_presenter.alarm_none()) {
                ...
                if (scui_presenter.alarm_near_state()) {
                    ...
                    scui_widget_draw_image(event->object, &image_on_clip, false, image_on, NULL, SCUI_COLOR_UNUSED);
                    scui_area_t image_dot_clip = {.x = 346, .y = 74,};
                    image_dot_clip.w = scui_image_w(image_dot); image_dot_clip.h = scui_image_h(image_dot);
                    scui_widget_draw_image(event->object, &image_dot_clip, false, image_dot, NULL, SCUI_COLOR_UNUSED);
                } else {
                    scui_area_t image_on_clip = {.x = 316, .y = 71,};
                    image_on_clip.w = scui_image_w(image_on); image_on_clip.h = scui_image_h(image_on);
                    scui_widget_draw_image(event->object, &image_on_clip, false, image_on, NULL, SCUI_COLOR_UNUSED);
                ...
                if ((scui_presenter.alarm_near_date() & 0x1000) != 0)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_0X00c5, lang_type));
                if ((scui_presenter.alarm_near_date() & 0x2000) != 0)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_0X00f8, lang_type));
                if ((scui_presenter.alarm_near_date() & 0x8000) != 0)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_0X00f2, lang_type));
                if ((scui_presenter.alarm_near_date() & 0x7f) == 0x7f)
                    snprintf(data_unit + strlen(data_unit), sizeof(data_unit) - strlen(data_unit),
                        "%s", scui_lang_str(SCUI_LANG_0X00f1, lang_type));
        ...
        case scui_ui_scene_mini_card_type_sleep: {
            ...
            if (scui_presenter.sleep_none()) {
                ...
                scui_widget_draw_image(event->object, &image_clip_l, false, image_l, NULL, SCUI_COLOR_UNUSED);
                scui_widget_draw_image(event->object, &image_clip_r, false, image_r, NULL, SCUI_COLOR_UNUSED);
                ...
                scui_widget_draw_color(event->object, &image_clip_c, false, SCUI_COLOR_MAKE32(false, 0x0, 0xFF6A6A6A));
                ...
                snprintf(data_unit, sizeof(data_unit), "%02d%s%02d%s",
                    scui_presenter.sleep_hour(),   scui_lang_str(SCUI_LANG_0X013b, lang_type),
                    scui_presenter.sleep_minute(), scui_lang_str(SCUI_LANG_0X013c, lang_type));
                ...
                for (uint8_t idx = 0; idx < 4; idx++) {
                    ...
                    image_clip_c.h = scui_image_h(image_l);
                    scui_widget_draw_color(event->object, &image_clip_c, false, SCUI_COLOR_MAKE32(false, 0x0, color4[idx]));
        ...
        case scui_ui_scene_mini_card_type_sport_record: {
            ...
            if (scui_presenter.sport_record_none()) {
                ...
                char data_unit[50] = {0};
                snprintf(data_unit, sizeof(data_unit), "%02d%s%02d%s",
                    scui_presenter.sport_record_hour(),   scui_lang_str(SCUI_LANG_0X013b, lang_type),
                    scui_presenter.sport_record_minute(), scui_lang_str(SCUI_LANG_0X013c, lang_type));
        ...
        case scui_ui_scene_mini_card_type_women_health: {
            ...
            if (scui_presenter.women_health_none()) {
                ...
                char data_unit[50] = {0};
                snprintf(data_unit, sizeof(data_unit), "%02d%s%02d%s",
                    scui_presenter.women_health_hour(),   scui_lang_str(SCUI_LANG_0X013b, lang_type),
                    scui_presenter.women_health_minute(), scui_lang_str(SCUI_LANG_0X013c, lang_type));
    ...
    scui_presenter.compass_angle() * SCUI_SCALE_COF);
                ...
                } dir_table[] =
                {
                    ...
                    { (315) + (45 / 2), (0)   + (45 / 2), SCUI_LANG_0X011e },
                    { (0)   + (45 / 2), (45)  + (45 / 2), SCUI_LANG_0X0123 },
                    { (45)  + (45 / 2), (90)  + (45 / 2), SCUI_LANG_0X0121 },
                    { (90)  + (45 / 2), (135) + (45 / 2), SCUI_LANG_0X0122 },
                    { (135) + (45 / 2), (180) + (45 / 2), SCUI_LANG_0X0120 },
                    { (180) + (45 / 2), (225) + (45 / 2), SCUI_LANG_0X0125 },
                    { (225) + (45 / 2), (270) + (45 / 2), SCUI_LANG_0X011f },
                    { (270) + (45 / 2), (315) + (45 / 2), SCUI_LANG_0X0124 }
                };
        ...
        case scui_ui_scene_mini_card_type_altimeter: {
            ...
            scui_widget_draw_color(event->object, &color_clip, false, SCUI_COLOR_MAKE32(false, 0x0, 0xFF4D4D4D));
...
static void scui_ui_scene_item_m_event_proc(scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        scui_widget_draw_image(event->object, &target, false, image, NULL, SCUI_COLOR_UNUSED);
        #endif
...
void scui_ui_scene_mini_card_scroll_event(scui_event_t *event)
{
    ...
    case scui_event_create: {
        ...
        for (uint8_t idx = 0; idx < scui_ui_scene_mini_card_num; idx++) {
            ...
            scui_ui_res_local->linear_m[idx] = linear_m_handle;
            scui_ui_res_local->linear_s[idx] = linear_s_handle;
        }
        ...
        // list的各个子控件树
        for (uint8_t idx = 0; idx < scui_ui_scene_mini_card_num; idx++) {
            linear_s_handle = scui_ui_res_local->linear_s[idx];
            ...
            case scui_ui_scene_mini_card_type_music_control: {
                ...
                string_t_maker.text = SCUI_LANG_0X0176;
            ...
            case scui_ui_scene_mini_card_type_stress: {
                ...
                if (type == scui_ui_scene_mini_card_type_hr) {
                    ...
                    string_t_maker.text = SCUI_LANG_0X0019;
                }
                if (type == scui_ui_scene_mini_card_type_spo2) {
                    string_t_maker.args.color.color_s.full = 0xFFFF0000;
                    string_t_maker.args.color.color_e.full = 0xFFFF0000;
                    string_t_maker.text = SCUI_LANG_0X0040;
                }
                if (type == scui_ui_scene_mini_card_type_stress) {
                    string_t_maker.args.color.color_s.full = 0xFF00F4EA;
                    string_t_maker.args.color.color_e.full = 0xFF00F4EA;
                    string_t_maker.text = SCUI_LANG_0X0049;
                }
            ...
            case scui_ui_scene_mini_card_type_weather: {
                ...
                string_t_maker.text = SCUI_LANG_0X0092;
            ...
            case scui_ui_scene_mini_card_type_alarm: {
                ...
                string_t_maker.text = SCUI_LANG_0X00e6;
                ...
                if (scui_presenter.alarm_none()) {
                    ...
                    string_t_maker.args.color.color_s.full = 0xFF4D4D4D;
                    string_t_maker.args.color.color_e.full = 0xFF4D4D4D;
                    string_t_maker.text = SCUI_LANG_0X00f0;
                    scui_widget_create(&string_t_maker, &string_handle);
                    ...
                    string_t_maker.args.color.color_s.full = 0xFF4D4D4D;
                    string_t_maker.args.color.color_e.full = 0xFF4D4D4D;
                    string_t_maker.text = SCUI_LANG_0X00e7;
                    scui_widget_create(&string_t_maker, &string_handle);
                    #endif
                } else {
                    string_t_maker.widget.clip.y = 69;
            ...
            case scui_ui_scene_mini_card_type_sleep: {
                ...
                string_t_maker.text = SCUI_LANG_0X004f;
                ...
                if (scui_presenter.sleep_none()) {
                    ...
                    string_t_maker.args.color.color_s.full = 0xFFFFFFFF;
                    string_t_maker.args.color.color_e.full = 0xFFFFFFFF;
                    string_t_maker.text = SCUI_LANG_0X0051;
                    scui_widget_create(&string_t_maker, &string_handle);
            ...
            case scui_ui_scene_mini_card_type_sport_record: {
                ...
                string_t_maker.text = SCUI_LANG_0X01c5;
                ...
                if (scui_presenter.sport_record_none()) {
                    ...
                    string_t_maker.args.color.color_s.full = 0xFFFFFFFF;
                    string_t_maker.args.color.color_e.full = 0xFFFFFFFF;
                    string_t_maker.text = SCUI_LANG_0X01c4;
                    scui_widget_create(&string_t_maker, &string_handle);
            ...
            case scui_ui_scene_mini_card_type_women_health: {
                ...
                string_t_maker.text = SCUI_LANG_0X0110;
            ...
            case scui_ui_scene_mini_card_type_compass: {
                ...
                string_t_maker.text = SCUI_LANG_0X011c;
                ...
                if (scui_presenter.compass_invalid()) {
                    ...
                    string_t_maker.args.color.color_s.full = 0xFF4D4D4D;
                    string_t_maker.args.color.color_e.full = 0xFF4D4D4D;
                    string_t_maker.text = SCUI_LANG_0X00f6;
                    scui_widget_create(&string_t_maker, &string_handle);
                    #endif
                } else {
            ...
            case scui_ui_scene_mini_card_type_altimeter: {
                ...
                string_t_maker.text = SCUI_LANG_0X012a;
                ...
                string_t_maker.widget.clip.h = 36;
                string_t_maker.args.align_hor = 2;
                string_t_maker.text = SCUI_LANG_0X0127;
                string_t_maker.args.color.color_s.full = 0xFF4D4D4D;
                string_t_maker.args.color.color_e.full = 0xFF4D4D4D;
                scui_widget_create(&string_t_maker, &string_handle);
                ...
                string_t_maker.widget.clip.h = 36;
                string_t_maker.args.align_hor = 2;
                string_t_maker.text = SCUI_LANG_0X0126;
                string_t_maker.args.color.color_s.full = 0xFF4D4D4D;
                string_t_maker.args.color.color_e.full = 0xFF4D4D4D;
                scui_widget_create(&string_t_maker, &string_handle);
            ...
            case scui_ui_scene_mini_card_type_stopwatch : {
                ...
                string_t_maker.text = SCUI_LANG_0X013f;
            ...
            case scui_ui_scene_mini_card_type_countdown : {
                ...
                string_t_maker.text = SCUI_LANG_0X0139;
            ...
            case scui_ui_scene_mini_card_type_world_time : {
                ...
                string_t_maker.text = SCUI_LANG_0X0140;
