...
void scui_ui_mask_all_event_proc(scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        scui_handle_t image_mask_u = scui_image_prj_rpt_mask_06_big_up;
        ...
        scui_handle_t image_mask_d = scui_image_prj_rpt_mask_05_big_down;
        ...
        scui_handle_t image_mask_a = scui_image_prj_rpt_mask_12_all_mask;
