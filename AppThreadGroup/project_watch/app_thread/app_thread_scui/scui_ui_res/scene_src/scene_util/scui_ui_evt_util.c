...
void scui_ui_mask_all_event_proc(scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        scui_handle_t image_mask_u = scui_image_prj_repeat_mask_06_big_up;
        ...
        scui_handle_t image_mask_d = scui_image_prj_repeat_mask_05_big_down;
        ...
        scui_handle_t image_mask_a = scui_image_prj_repeat_mask_12_all_mask;
        clip.w = scui_image_w(image_mask_a);
        clip.h = scui_image_h(image_mask_a);
        clip.x = (SCUI_HOR_RES - clip.w) / 2;
        clip.y = (SCUI_VER_RES - clip.h) / 2;
        // scui_widget_draw_image(event->object, &clip, SCUI_COLOR_UNUSED, image_mask_a, NULL);
