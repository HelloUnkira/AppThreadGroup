...
void scui_ui_bar_arc_event_proc(scui_ui_bar_arc_t *bar_arc, scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        scui_handle_t image_bg   = scui_image_prj_rpt_slider_04_bg;     // 44 * 236
        scui_handle_t image_ring = scui_image_prj_rpt_slider_03_ring;
        scui_handle_t image_edge = scui_image_prj_rpt_slider_02_dot;
