...
void scui_ui_scene_float_3_ring_event_proc(scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        #if 0   // 三象限(测试)
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, 60, color, 120 + 10 + 90, 100);
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, 150, color, 210 + 10 + 90, 100);
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, 240, color, 300 + 10 + 90, 100);
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, -30, color, 30 + 10 + 90, 100);
        #endif
        
        #if 0   // 四象限(测试)
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, 60, color, 120 + 10 + 180, 100);
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, 150, color, 210 + 10 + 180, 100);
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, 240, color, 300 + 10 + 180, 100);
        // scui_widget_draw_ring(event->object, &clip, image_edge, image_ring, NULL, -30, color, 30 + 10 + 180, 100);
        #endif
...
void scui_ui_scene_float_3_btn_event_proc(scui_event_t *event)
{
    ...
    case scui_event_create: {
        ...
        button_maker.image.image[0] = scui_image_prj_image_src_repeat_card_04_r36_1bmp;
        button_maker.image.image[1] = scui_image_prj_image_src_repeat_card_05_r36_2bmp;
        button_maker.image.image[2] = scui_image_prj_image_src_repeat_card_06_r36_3bmp;
        button_maker.image.image[3] = scui_image_prj_image_src_repeat_card_07_r36_4bmp;
        ...
        button_maker.image.image[0] = scui_image_prj_image_src_repeat_box_sleep_breathe_02_left_upbmp;
        button_maker.image.image[1] = scui_image_prj_image_src_repeat_box_sleep_breathe_04_right_upbmp;
        button_maker.image.image[2] = scui_image_prj_image_src_repeat_box_sleep_breathe_01_left_downbmp;
        button_maker.image.image[3] = scui_image_prj_image_src_repeat_box_sleep_breathe_03_right_downbmp;
