...
void scui_ui_scene_3_event_proc(scui_event_t *event)
{
    ...
    case scui_event_draw_graph: {
        ...
        scui_handle_t heart_src = scui_image_prj_theme_icon_00_heart_06_05png;
        scui_handle_t heart_idx = scui_image_prj_theme_icon_00_heart_index_06_05png;
        scui_handle_t spo2_src  = scui_image_prj_theme_icon_01_spo2_06_05png;
        scui_handle_t spo2_idx  = scui_image_prj_theme_icon_01_spo2_index_06_05png;
        scui_handle_t sun_src   = scui_image_prj_weather_weather_big_00_sun_01_00jpg;
        scui_handle_t sun_idx   = scui_image_prj_weather_weather_big_00_sun_index_01_00jpg;
        scui_handle_t bfly_src  = scui_image_prj_3d_Butterfly_SwingDown0png;
        scui_handle_t bfly_idx  = scui_image_prj_3d_Butterfly_index_SwingDown0png;
