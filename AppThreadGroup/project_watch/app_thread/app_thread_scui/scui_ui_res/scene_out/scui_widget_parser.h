...
typedef enum {
	...
	SCUI_UI_SCENE_TEST_UI_LIST_SCROLL, // 4124, 0x101c
	SCUI_UI_SCENE_TEST_UI_LIST_ITEM_1, // 4125, 0x101d
	SCUI_UI_SCENE_TEST_UI_LIST_ITEM_2, // 4126, 0x101e
	SCUI_UI_SCENE_TEST_UI_LIST_ITEM_3, // 4127, 0x101f
	SCUI_UI_SCENE_TEST_UI_LIST_ITEM_4, // 4128, 0x1020
	SCUI_UI_SCENE_TEST_UI_LIST_ITEM_5, // 4129, 0x1021
	SCUI_UI_SCENE_TEST_UI_MAIN, // 4130, 0x1022
	SCUI_UI_SCENE_TEST_UI_MAIN_HOME, // 4131, 0x1023
	SCUI_UI_SCENE_TEST_UI_MAIN_TEST, // 4132, 0x1024
	SCUI_UI_SCENE_TEST_UI_OBJECT, // 4133, 0x1025
	SCUI_UI_SCENE_TEST_UI_OBJECT_SCROLL, // 4134, 0x1026
	SCUI_UI_SCENE_TEST_UI_OBJECT_PAGE_1, // 4135, 0x1027
	SCUI_UI_SCENE_TEST_UI_OBJECT_PAGE_2, // 4136, 0x1028
	SCUI_UI_SCENE_TEST_UI_OBJECT_PAGE_3, // 4137, 0x1029
	SCUI_UI_SCENE_TEST_UI_SCROLL, // 4138, 0x102a
	SCUI_UI_SCENE_TEST_UI_STRING, // 4139, 0x102b
	SCUI_UI_SCENE_TEST_UI_SYMBOL, // 4140, 0x102c
	SCUI_UI_SCENE_TEST_UI_SYMBOL_CANVAS, // 4141, 0x102d
	SCUI_UI_SCENE_ACTIVITY, // 4142, 0x102e
	SCUI_UI_SCENE_ACTIVITY_SCROLL, // 4143, 0x102f
	SCUI_UI_SCENE_ACTIVITY_BAR_ARC, // 4144, 0x1030
	SCUI_UI_SCENE_ACTIVITY_SCROLL_RING_BIG_3, // 4145, 0x1031
	SCUI_UI_SCENE_ACTIVITY_SCROLL_DITAIL_TITLE, // 4146, 0x1032
	SCUI_UI_SCENE_ACTIVITY_SCROLL_DITAIL_SUM, // 4147, 0x1033
	SCUI_UI_SCENE_ACTIVITY_SCROLL_DITAIL_KCAL, // 4148, 0x1034
	SCUI_UI_SCENE_ACTIVITY_SCROLL_DITAIL_STEP, // 4149, 0x1035
	SCUI_UI_SCENE_ACTIVITY_SCROLL_DITAIL_DIST, // 4150, 0x1036
	SCUI_UI_SCENE_ACTIVITY_SCROLL_BLANK, // 4151, 0x1037
	SCUI_UI_SCENE_HOME, // 4152, 0x1038
	SCUI_UI_SCENE_MINI_CARD, // 4153, 0x1039
	SCUI_UI_SCENE_MINI_CARD_BAR_ARC, // 4154, 0x103a
	SCUI_UI_SCENE_MINI_CARD_MASK, // 4155, 0x103b
	SCUI_UI_SCENE_NONE, // 4156, 0x103c
	SCUI_UI_SCENE_NOTIFY, // 4157, 0x103d
	SCUI_UI_SCENE_QUICK_CARD, // 4158, 0x103e
	SCUI_UI_SCENE_STANDBY, // 4159, 0x103f
	SCUI_UI_SCENE_FLOAT_1, // 4160, 0x1040
	SCUI_UI_SCENE_FLOAT_1_1, // 4161, 0x1041
	SCUI_UI_SCENE_FLOAT_1_2, // 4162, 0x1042
	SCUI_UI_SCENE_FLOAT_2, // 4163, 0x1043
	SCUI_UI_SCENE_FLOAT_3, // 4164, 0x1044
	SCUI_UI_SCENE_FLOAT_3_RING, // 4165, 0x1045
	SCUI_UI_SCENE_FLOAT_3_BTN, // 4166, 0x1046
	SCUI_UI_SCENE_FLOAT_4, // 4167, 0x1047
	SCUI_UI_SCENE_1, // 4168, 0x1048
	SCUI_UI_SCENE_1_SCROLL, // 4169, 0x1049
	SCUI_UI_SCENE_1_SCROLL_PAGE_1, // 4170, 0x104a
	SCUI_UI_SCENE_1_SCROLL_PAGE_2, // 4171, 0x104b
	SCUI_UI_SCENE_1_SCROLL_PAGE_3, // 4172, 0x104c
	SCUI_UI_SCENE_2, // 4173, 0x104d
	SCUI_UI_SCENE_2_BAR_ARC, // 4174, 0x104e
	SCUI_UI_SCENE_3, // 4175, 0x104f
	SCUI_UI_SCENE_6, // 4176, 0x1050
	SCUI_UI_SCENE_6_1, // 4177, 0x1051
	SCUI_UI_SCENE_6_2, // 4178, 0x1052
	SCUI_UI_SCENE_6_3, // 4179, 0x1053
	SCUI_UI_SCENE_6_4, // 4180, 0x1054
	SCUI_UI_SCENE_6_5, // 4181, 0x1055
	SCUI_UI_SCENE_6_6, // 4182, 0x1056
	SCUI_UI_SCENE_6_7, // 4183, 0x1057
	SCUI_UI_SCENE_6_8, // 4184, 0x1058
	SCUI_UI_SCENE_6_9, // 4185, 0x1059
	SCUI_UI_SCENE_TEST, // 4186, 0x105a
} scui_widget_parser_handle_t;

extern const void * const scui_widget_parser_table[91];
