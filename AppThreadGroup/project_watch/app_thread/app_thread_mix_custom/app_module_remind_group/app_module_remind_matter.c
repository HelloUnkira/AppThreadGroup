...
void app_module_remind_matter_dump(void)
{
    ...
    memcpy(&data_center_src->module_remind_matter.matter_item, app_module_remind_matter_item, sizeof(app_module_remind_matter_item));
    memcpy(&data_center_src->module_remind_matter.matter_info, app_module_remind_matter_info, sizeof(app_module_remind_matter_info));
...
void app_module_remind_matter_load(void)
{
    ...
    app_module_data_center_src_t *data_center_src = app_module_data_center_take(app_module_data_center_src_module_source);
    app_module_remind_matter_array_lock();
    memcpy(app_module_remind_matter_item, &data_center_src->module_remind_matter.matter_item, sizeof(app_module_remind_matter_item));
    memcpy(app_module_remind_matter_info, &data_center_src->module_remind_matter.matter_info, sizeof(app_module_remind_matter_info));
    app_module_remind_matter_array_unlock();
    app_module_data_center_give();
}
