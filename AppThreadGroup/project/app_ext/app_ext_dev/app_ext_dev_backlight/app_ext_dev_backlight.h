 ...
 *@param[in] driver 设备实例
 */
static inline void app_dev_backlight_dlps_enter(app_dev_t *driver)
{
    if (driver != NULL && driver->api != NULL) {
        const app_dev_backlight_api_t *api = driver->api;
 ...
 *@param[in] driver 设备实例
 */
static inline void app_dev_backlight_dlps_exit(app_dev_t *driver)
{
    if (driver != NULL && driver->api != NULL) {
        const app_dev_backlight_api_t *api = driver->api;
 ...
 *@param[in] driver 设备实例
 */
static inline void app_dev_backlight_shutdown_enter(app_dev_t *driver)
{
    if (driver != NULL && driver->api != NULL) {
        const app_dev_backlight_api_t *api = driver->api;
 ...
 *@param[in] driver 设备实例
 */
static inline void app_dev_backlight_shutdown_exit(app_dev_t *driver)
{
    if (driver != NULL && driver->api != NULL) {
        const app_dev_backlight_api_t *api = driver->api;
