 ...
 *@param[in] driver 设备实例
 */
static void app_dev_backlight_hal_dlps_enter(app_dev_t *driver)
{
    const app_dev_backlight_cfg_t *cfg = driver->cfg;
    app_dev_backlight_data_t *data = driver->data;
    /* 填充目标平台下的动作 */
 ...
 *@param[in] driver 设备实例
 */
static void app_dev_backlight_hal_dlps_exit(app_dev_t *driver)
{
    const app_dev_backlight_cfg_t *cfg = driver->cfg;
    app_dev_backlight_data_t *data = driver->data;
    /* 填充目标平台下的动作 */
 ...
 *@param[in] driver 设备实例
 */
static void app_dev_backlight_hal_shutdown_enter(app_dev_t *driver)
{
    const app_dev_backlight_cfg_t *cfg = driver->cfg;
    app_dev_backlight_data_t *data = driver->data;
    /* 填充目标平台下的动作 */
 ...
 *@param[in] driver 设备实例
 */
static void app_dev_backlight_hal_shutdown_exit(app_dev_t *driver)
{
    const app_dev_backlight_cfg_t *cfg = driver->cfg;
    app_dev_backlight_data_t *data = driver->data;
    /* 填充目标平台下的动作 */
...
static const app_dev_backlight_api_t app_dev_backlight_api = {
    ...
    .dlps_enter         = app_dev_backlight_hal_dlps_enter,
    .dlps_exit          = app_dev_backlight_hal_dlps_exit,
    .shutdown_enter     = app_dev_backlight_hal_shutdown_enter,
    .shutdown_exit      = app_dev_backlight_hal_shutdown_exit,
};
